...
function generateFileLinks(romPath, imagePath) {
    ...
    fileNames.forEach(fileName => {
        ...
        <figure><img loading="lazy" src="https://raw.githubusercontent.com/WizzardSK/${imagePath}/master/Named_Snaps/${nameWithoutExt}.png" alt="${fileName}">
        <figcaption>${decodeURIComponent(nameWithoutExt)}</figcaption></figure></a>`);
    });
    document.write("</div>");
}
