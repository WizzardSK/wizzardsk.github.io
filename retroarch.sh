...
*"MAME/Software List ROMs (split)/wswan/"*) core="mednafen_wswan_libretro";;
*"No-Intro/Benesse - Pocket Challenge V2/"*) core="mednafen_wswan_libretro";;
*"MAME/Software List ROMs (merged)/pockchalv2/"*) core="mednafen_wswan_libretro";;
*"MAME/Software List ROMs (split)/pockchalv2/"*) core="mednafen_wswan_libretro";;
...
*"MAME/Software List ROMs (merged)/wscolor/"*) core="mednafen_wswan_libretro";;
*"MAME/Software List ROMs (split)/wscolor/"*) core="mednafen_wswan_libretro";;
...
*"MAME/Software List ROMs (merged)/famicom_flop/"*) core="nestopia_libretro";;
*"MAME/Software List ROMs (split)/famicom_flop/"*) core="nestopia_libretro";;
...
*"MAME/Software List CHDs (merged)/megacd/"*) core="picodrive_libretro";;
...
*"MAME/Software List CHDs (merged)/saturn/"*) core="yabasanshiro_libretro";;
...
*"MAME/Software List CHDs (merged)/dc/"*) core="flycast_libretro";;
...
*"MAME/Software List CHDs (merged)/psx/"*) core="pcsx_rearmed_libretro";;
...
*"MAME/Software List ROMs (split)/pce_tourvision/"*) core="mednafen_pce_fast_libretro";;
...
*"MAME/Software List ROMs (merged)/sgx/"*) core="mednafen_supergrafx_libretro";;
*"MAME/Software List ROMs (split)/sgx/"*) core="mednafen_supergrafx_libretro";;
...
*"MAME/Software List CHDs (merged)/pcecd/"*) core="mednafen_pce_fast_libretro";;
...
*"MAME/Software List ROMs (merged)/pet_cass/"*) core="vice_xpet_libretro";;
*"MAME/Software List ROMs (split)/pet_cass/"*) core="vice_xpet_libretro";;
...
*"MAME/Software List ROMs (merged)/plus4_cart/"*) core="vice_xplus4_libretro";;
*"MAME/Software List ROMs (split)/plus4_cart/"*) core="vice_xplus4_libretro";;
...
*"MAME/Software List ROMs (merged)/vic1001_cart/"*) core="vice_xvic_libretro";;
*"MAME/Software List ROMs (split)/vic1001_cart/"*) core="vice_xvic_libretro";;
...
*"MAME/Software List ROMs (merged)/c64_cart/"*) core="vice_x64sc_libretro";;
*"MAME/Software List ROMs (split)/c64_cart/"*) core="vice_x64sc_libretro";;
...
*"MAME/Software List ROMs (merged)/c128_cart/"*) core="vice_x128_libretro";;
*"MAME/Software List ROMs (split)/c128_cart/"*) core="vice_x128_libretro";;
*"MAME/Software List ROMs (merged)/c128_flop/"*) core="vice_x128_libretro";;
*"MAME/Software List ROMs (split)/c128_flop/"*) core="vice_x128_libretro";;
*"MAME/Software List ROMs (merged)/c128_rom/"*) core="vice_x128_libretro";;
*"MAME/Software List ROMs (split)/c128_rom/"*) core="vice_x128_libretro";;
...
*"MAME/Software List ROMs (split)/ngp/"*) core="mednafen_ngp_libretro"; ext="bin";;
