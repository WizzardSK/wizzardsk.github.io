...
*"/megacd/ISO/"*) core="picodrive_libretro"; ext="cue"; src="https://archive.org/download/tosec-iso-sega/Mega-CD%20%26%20Sega%20CD/CD/Games/%5BISO%5D/";;
...
*"/saturn/ISO/"*) core="yabasanshiro_libretro"; ext="cue"; src="https://archive.org/download/tosec-iso-sega/Saturn/Games/%5BISO%5D/";;
...
*"/dos/Edu TOSEC/"*) core="dosbox_pure_libretro"; src="https://archive.org/download/tosec-main/IBM/PC%20Compatibles/Educational/%5BCP2%5D/IBM%20PC%20Compatibles%20-%20Educational%20-%20%5BCP2%5D%20%28TOSEC-v2023-11-07%29.zip/";;
...
if [[ -n "$src" && ! -e "$1" ]]; then
  ...
  # URL-encode the inner path, preserving '/' between segments
