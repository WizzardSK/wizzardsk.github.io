...
*"MAME/Software List ROMs (merged)/sg1000") core="mame sg1000 -cart1";;
*"MAME/Software List ROMs (split)/sg1000") core="mame sg1000 -cart1";;
...
*"MAME/Software List ROMs (merged)/sms") core="mame sms -cart1";;
*"MAME/Software List ROMs (split)/sms") core="mame sms -cart1";;
...
*"MAME/Software List ROMs (split)/pico") core="mame pico -cart1";;
*"No-Intro/Sega - 32X") core="picodrive_libretro";;
*"TOSEC/Sega/32X/Games") core="picodrive_libretro";;
*"MAME/Software List ROMs (merged)/32x") core="mame 32x -cart1";;
*"MAME/Software List ROMs (split)/32x") core="mame 32x -cart1";;
...
*"MAME/Software List ROMs (merged)/gamegear") core="mame gamegear -cart1";;
*"MAME/Software List ROMs (split)/gamegear") core="mame gamegear -cart1";;
