...
*"MAME/Software List ROMs (merged)/pro128_cass/"*) core="mame pro128 -autoboot_command 'RUNCASS:\n' -autoboot_delay 8 -cass";;
*"MAME/Software List ROMs (split)/pro128_cass/"*) core="mame pro128 -autoboot_command 'RUNCASS:\n' -autoboot_delay 8 -cass";;
